                ...
                <div class="card-content">
                    ...
                    <form method='post' action="{{route('superadmin.landing.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="container">
                            ...
                            <div class="form-row">
                            <div class="form-group col-md-12">
                                <button type="submit" style="background-color:green;color:white"  class="btn btn-primary">SUBMIT</button>
                            </div>
                            </div>
                        </div>
                    </form>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2" id="" name='category[]' style="width: 250px; height: 40px;">
                                        <option selected disabled readonly>Select Category 2</option>
                                        @foreach($category as $cat)
                                        <option value="{{$cat->id}}">{{$cat->name}}</option>
                                        @endforeach
                                    </select>
                    ...
                    <form method='post' action="{{route('superadmin.landing.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <button type="submit" style="background-color:green;color:white"  class="form-control">Upload Slide</button>
                        </div>
                    </form>
                </div>
            </div>
