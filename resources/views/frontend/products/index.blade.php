                                        ...
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner px-xl-4 p-3">
                                                <div class="product-item__body pb-xl-2">
                                                    ...
                                                    <h5 class="mb-1 product-item__title"><a href="{{route('products.show', $product->id)}}" class="text-blue font-weight-bold">{{$product->name}}</a></h5>
                                                    <div class="mb-2">
                                                        @foreach ($product->images as $image)
                                                        <a href="#" class="d-block text-center"><img class="img-fluid" src="{{Storage::url($image->url)}}" alt="Image Description"></a>    
                                                        @endforeach
