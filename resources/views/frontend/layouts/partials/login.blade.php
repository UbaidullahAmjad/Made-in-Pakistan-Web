<aside id="sidebarContentcategory" class="u-sidebar u-sidebar__lg" aria-labelledby="sidebarNavToggler">
    <div class="u-sidebar__scroller">
        <div class="u-sidebar__container">
            <div class="js-scrollbar u-header-sidebar__footer-offset pb-3">
                <!-- Toggle Button -->
                <div class="d-flex align-items-center pt-4 px-7">
                    <button type="button" class="close ml-auto" aria-controls="sidebarContent" aria-haspopup="true" aria-expanded="false" data-unfold-event="click" data-unfold-hide-on-scroll="false" data-unfold-target="#sidebarContentcategory" data-unfold-type="css-animation" data-unfold-animation-in="fadeInRight" data-unfold-animation-out="fadeOutRight" data-unfold-duration="500">
                        <i class="ec ec-close-remove" onClick="reload"></i>
                    </button>
                </div>
                <!-- End Toggle Button -->
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <form>
                                        @csrf
                                        <div class="mb-2">
                                            <a id="sidebarNavToggler" href="javascript:;" role="button" class="u-header-topbar__nav-link" aria-controls="sidebarContent" aria-haspopup="true" aria-expanded="false" data-unfold-event="click" data-unfold-hide-on-scroll="false" data-unfold-target="#sidebarContentbuyer" data-unfold-type="css-animation" data-unfold-animation-in="fadeInRight" data-unfold-animation-out="fadeOutRight" data-unfold-duration="500">
                                                <i class="ec ec-user mr-1"></i> Buyer <span class="text-gray-50">or</span> Sign in
                                            </a>
                                        </div>
                                    </form>
                                </div>
                                <div class="col-6">
                                    <form>
                                        @csrf
                                        <div class="mb-2">
                                            <a id="sidebarNavToggler" href="javascript:;" role="button" class="u-header-topbar__nav-link" aria-controls="sidebarContent" aria-haspopup="true" aria-expanded="false" data-unfold-event="click" data-unfold-hide-on-scroll="false" data-unfold-target="#sidebarContentseller" data-unfold-type="css-animation" data-unfold-animation-in="fadeInRight" data-unfold-animation-out="fadeOutRight" data-unfold-duration="500">
                                                <i class="ec ec-user mr-1"></i> Seller <span class="text-gray-50">or</span> Sign in
                                            </a>
                                        </div>
                                    </form>
                                </div>
...
<!-- buyer login -->
<aside id="sidebarContentbuyer" class="u-sidebar u-sidebar__lg" aria-labelledby="sidebarNavToggler">
    <div class="u-sidebar__scroller">
        <div class="u-sidebar__container">
            <div class="js-scrollbar u-header-sidebar__footer-offset pb-3">
                <!-- Toggle Button -->
                ...
                <div class="js-scrollbar u-sidebar__body">
                    <div class="u-sidebar__content u-header-sidebar__content">
                            ...
                            <!-- Login -->
                            <form class="js-validate" method="post" action="{{route('buyer.login.submit')}}">
                            @csrf
                            <div id="login" data-target-group="idForm">
                                <!-- Title -->
                                <header class="text-center mb-7">
                                    <h2 class="h4 mb-0">Welcome Back!</h2>
                                    <p>Login to manage your buyer account.</p>
                                </header>
                                <!-- End Title -->
                                ...
                                <div class="text-center mb-4">
                                    ...
                                    <a class="js-animation-link small text-dark" href="javascript:;" data-target="#signupbuyer" data-link-group="idForm" data-animation-in="slideInUp">Signup
                                    </a>
                                </div>
                                ...
                                <!-- Login Buttons -->
                                <div class="d-flex">
                                    <a class="btn btn-block btn-sm btn-soft-facebook transition-3d-hover mr-1" href="redirect">
                                        <span class="fab fa-facebook-square mr-1"></span>
                                        Facebook
                                    </a>
                                    <a class="btn btn-block btn-sm btn-soft-google transition-3d-hover ml-1 mt-0" href="{{url('/redirect')}}">
                            ...
                            <div id="signupbuyer" style="display: none; opacity: 0;" data-target-group="idForm">
                        
                                <!-- Title -->
                                <header class="text-center mb-7">
                                    <h2 class="h4 mb-0">Welcome to MadeInPak.</h2>
                                    ...
                                    <div class="form-group">
                                        <div class="js-form-message js-focus-state">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="name" id="signupname" placeholder="Name" aria-label="Email" aria-describedby="signupNameLabel" required data-msg="Please enter a valid name." data-error-class="u-has-error" data-success-class="u-has-success">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- End Input -->
                                ...
                                <div class="d-flex">
                                    ...
                                    <a class="btn btn-block btn-sm btn-soft-google transition-3d-hover ml-1 mt-0" href="gmail">
                                        <span class="fab fa-google mr-1"></span>
                                        Google
                                    </a>
                                </div>
...
<!-- seller login -->
<aside id="sidebarContentseller" class="u-sidebar u-sidebar__lg" aria-labelledby="sidebarNavToggler">
    <div class="u-sidebar__scroller">
        <div class="u-sidebar__container">
            <div class="js-scrollbar u-header-sidebar__footer-offset pb-3">
                <!-- Toggle Button -->
                ...
                <div class="js-scrollbar u-sidebar__body">
                    <div class="u-sidebar__content u-header-sidebar__content">
                            ...
                            <!-- Login -->
                            <form class="js-validate" method="post" action="{{route('seller.login.submit')}}">
                            @csrf
                            <div id="login" data-target-group="idForm">
                                <!-- Title -->
                                <header class="text-center mb-7">
                                ...
                                <div class="text-center mb-4">
                                    <span class="small text-muted">Do not have an account?</span>
                                    <a class="js-animation-link small text-dark" href="javascript:;" data-target="#signupseller" data-link-group="idForm" data-animation-in="slideInUp">Signup
                                    </a>
                                </div>
                            ...
                            <!-- Signup -->
                            <div id="signupseller" style="display: none; opacity: 0;" data-target-group="idForm">
                                <!-- Title -->
                                <header class="text-center mb-7">
                                    <h2 class="h4 mb-0">Welcome to MadeInPak.</h2>
                                    <p>Fill out the form to get started.</p>
