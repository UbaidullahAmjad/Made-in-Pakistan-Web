                        ...
                        <div id="basicsAccordion">
                            ...
                            <div class="card border-0">
                                <div class="card-header card-collapse border-0 flex-center-between bg-primary text-lh-1 rounded-0" id="basicsHeadingOne">
                                    ...
                                    <a href="{{ route('more.categories') }}" class="d-block font-size-13 py-3 pr-4 font-weight-bold text-gray-90 ml-auto flex-shrink-0">View All</a>
                                </div>
                                                            ...
                                                            <div class="row u-header__mega-menu-wrapper">
                                                                ...
                                                                <div class="col mb-3 mb-sm-0">
                                                                    ...
                                                                    <ul class="u-header__sub-menu-nav-group mb-3">
                                                                        ...
                                                                        <li><a class="nav-link u-header__sub-menu-nav-link" href="{{route('item.produts',$item->id)}}">{{ $item->name }}</a></li>
                                                                        @endforeach
                    ...
                    <div class="max-width-890-wd max-width-660-xl">
                        ...
                        <ul class="list-group list-group-horizontal-sm position-relative z-index-2 flex-row overflow-auto overflow-md-visble">
                            ...
                            <li class="list-group-item py-2 px-3 px-xl-4 px-wd-5 flex-horizontal-center shadow-on-hover-1 rounded-0 border-top-0 border-bottom-0 flex-shrink-0 flex-md-shrink-1">
                                <a href="{{ url('categories',$randombelow->id) }}" class="d-block py-2 text-center">
                                     @foreach($randombelow->images as $img)
                            <img class="img" width="100px" height="100px" src="{{asset($img->url)}}"  alt="Image Description">
                        @endforeach
                    ...
                    <div class="max-width-240-xl">
                        <div class="d-md-flex d-xl-block">
                            ...
                            <div class="bg-white border-top">
                                <a href="{{ url('productDetail', $randomright->id ) }}" class="text-gray-90 position-relative d-block overflow-hidden">
                                    <div class="position-absolute transform-rotate-16-banner">
                                        <img class="img" @foreach ($randomright->pictures as $image)
                                                    src="{{asset('/product-images/'.$image->url) }}"
                                                    @endforeach
                                                    alt="Image Description" width="140" height="140" alt="Image Description">
                                    </div>
                                        ...
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <div class="flex-center-between mb-1">
                                                <div class="prodcut-price">
                                                    <div class="text-gray-100">Rs. &nbsp{{ $prod->min_price }}-{{ $prod->max_price }}</div>
                                                </div>
            ...
            <div class="row">
                <div class="mb-2">
                    <a  class="d-block text-center">
                        @foreach($discate->images as $img)
                            <img class="img" width="360px" height="616px" src="{{asset($img->url)}}"  alt="Image Description">
                        @endforeach
                    </a>
                </div>
                        ...
                        <div class="tab-pane fade show active" id="Bpills-one-example1" role="tabpanel" aria-labelledby="Bpills-one-example1-tab">
                            <div class="row products-group no-gutters">
                                        ...
                                        @foreach($discate->subcategory as $subcategory)
                                            ...
                                            <div class="product-item__body pb-xl-2">
                                                <div class="mb-2">
                                                    <h3><a href="{{url('productDetail',$product->id)}}" class="font-size-12 text-gray-5">{{$product->items->name}}</a></h3>
                                                </div>
                                                ...
                                                <div class="mb-2">
                                                    <a href="{{url('productDetail',$product->id)}}" class="d-block text-center"><img class="img-fluid" 
                                                    
                                                        
                                                        src="{{asset('/product-images/'.$product->pictures()->where('thumbnail',1)->first()->url) }}"
                                            ...
                                            <div class="product-item__footer">
                                                <div class="border-top pt-2 flex-center-between flex-wrap">
                                                    <a href="{{url('productDetail',$product->id)}}" class="text-gray-6 font-size-13"><i class="mr-1 font-size-15"></i>{{$product->minimum_order_qty}}</a>
                                                </div>
                                            </div>
                                            </div>
                                            </div>
