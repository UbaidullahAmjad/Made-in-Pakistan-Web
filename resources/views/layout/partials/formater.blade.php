<div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-xl-block"><a class="customizer-close" href="#"><i class="ft-x font-medium-3"></i></a><a class="customizer-toggle bg-primary box-shadow-3" href="#" id="customizer-toggle-setting"><i class="ft-settings font-medium-3 spinner white"></i></a><div class="customizer-content p-2 ps ps--active-y">
	...
	<div class="navbar-color-options clearfix">
		...
		<div class="solid-colors clearfix">
			<div class="bg-primary navbar-color-option active" data-bg="bg-primary" title="primary"></div>
	...
	<div class="row sidebar-color-options ml-0">
		...
		<div class="text-center mb-1">
			<input type="checkbox" id="sidebar-color-option" class="switchery" data-size="xs" data-switchery="true" style="display: none;"><span class="switchery switchery-xsmall switchery-default" style="box-shadow: 0px 0px 0px 0px inset; transition: border 0.4s ease 0s, box-shadow 0.4s ease 0s;"><small style="left: 0px; transition: background-color 0.4s ease 0s, left 0.2s ease 0s;"></small></span>
		</div>
	...
	<div class="float-right">
		<input type="checkbox" id="collapsed-sidebar" class="switchery" data-size="xs" data-switchery="true" style="display: none;"><span class="switchery switchery-xsmall switchery-default" style="box-shadow: 0px 0px 0px 0px inset; transition: border 0.4s ease 0s, box-shadow 0.4s ease 0s;"><small style="left: 0px; transition: background-color 0.4s ease 0s, left 0.2s ease 0s;"></small></span>
	</div>
	...
	<div class="cz-bg-image row">
		<div class="col mb-3">
			<img src="{{asset ('app-assets/images/backgrounds/04.jpg') }}" class="rounded sidiebar-bg-img selected" width="50" height="100" alt="background image">
		</div>
		<div class="col mb-3">
		...
		<div class="col mb-3">
			<img src="{{asset ('app-assets/images/backgrounds/05.jpg') }}" class="rounded sidiebar-bg-img" width="50" height="100" alt="background image">
		</div>
	</div>
	...
	<div class="sidebar-image-visibility">
		<div class="row ml-0">
			...
			<div class="text-center mb-1">
				<input type="checkbox" id="toggle-sidebar-bg-img" class="switchery" data-size="xs" checked="" style="display: none;" data-switchery="true"><span class="switchery switchery-xsmall switchery-default" style="box-shadow: rgb(250, 98, 107) 0px 0px 0px 9px inset; transition: border 0.4s ease 0s, box-shadow 0.4s ease 0s, background-color 1.2s ease 0s; background-color: rgb(250, 98, 107); border-color: rgb(250, 98, 107);"><small style="left: 12px; transition: background-color 0.4s ease 0s, left 0.2s ease 0s; background-color: rgb(255, 255, 255);"></small></span>
			</div>
...
<div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 757px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 651px;"></div></div></div>
    </div>