...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('app-assets/css/switchery.min.css') }}" />
    <link href="https://cdn.datatables.net/1.10.22/css/jquery.dataTables.min.css">
    <link href="{{ asset('css/app.css') }}">
    <script src="https://media.twiliocdn.com/sdk/js/chat/v3.3/twilio-chat.min.js"></script>
    <script src="{{ asset('app-assets/js/switchery.min.js') }}"></script>
...
@include('backend.superadmin.layout.partials.nav')
@include('backend.superadmin.layout.partials.left-nav')
...
@include('backend.superadmin.layout.partials.formater')
@include('backend.superadmin.layout.partials.footer')
<!-- BEGIN VENDOR JS-->
