            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <x-card title="Total Customers"
                            ...
                            :data="$customers->count()"></x-card>
                </div>
                <div class="col-lg-3">
                    <x-card title="Total Sellers" type="card bg-gradient-x-orange-yellow" :data="$sellers->count()"></x-card>
                </div>
                <div class="col-lg-3">
                    <x-card title="Total Sale"
                            type="card bg-gradient-directional-success"
                            :data="$orders->sum('total')"></x-card>
                </div>
                <div class="col-lg-3">
                    <x-card title="Avg Order Sale" type="card bg-gradient-x-info" data="avg"></x-card>
                </div>
                            ...
                            <div class="card-body">
                                @foreach ($products->take(5) as $product)
                                    ...
                                    @foreach($product->pictures()->where('thumbnail', 1)->get() as $image)
                                        {{ asset('/product-images/'.$image->url) }}
                                    @endforeach
                                    ">
                            ...
                            <div class="card-body">
                                <div class="col-12 timeline-left" id="activity">
                                    ...
                                    @foreach ($customers as $buyer)
                                            <tr>
                                                <td>{{ $buyer->name }}</td><td>{{ $buyer->email }}</td>
                                            </tr>
