			...
			<div class="card" style="height: 875px;">
				...
				<div class="card-content collapse show">
					<div class="card-body">
                        ...
                        <form class="form" action="{{ route('superadmin.items.store') }}" method="post">
                            @csrf
									...
									<div class="form-body">
                                        <div class="form-group">
											...
											<select id="maincategory" name="category_id" class="form-control" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Main Category" data-original-title="" title="">
                                                <option selected readonly disabled>Selecct Category</option>
										...
										<div class="form-group">
											...
											<input type="text" id="ItemName" class="form-control" placeholder="Item Name" name="name">
										</div>
                                </div>
								</div>
							</div>
