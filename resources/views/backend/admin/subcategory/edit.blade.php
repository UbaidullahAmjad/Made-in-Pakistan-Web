            ...
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        ...
                        <form class="form form-horizontal" action="{{route('superadmin.subcategory.update', $subcategory->id)}}" method="post">
                            @csrf()
                            @method('put')
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" id="eventRegInput1" class="form-control"
                                               placeholder="Hush Puppies.." name="name" value="{{$subcategory->name}}">
                                    </div>
                                </div>
                            </div>
