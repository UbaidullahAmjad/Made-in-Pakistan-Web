...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('vendor/theme-assets/css/components.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('vendor/theme-assets/css/pages/chat-application.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('vendor/theme-assets/css/bootstrap-extended.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('vendor/theme-assets/css/colors.min.css') }}">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
@yield('css')
<!-- END Custom CSS-->
...
@if (isset($message))
@include('layout.partials.left-nav', ['message' => $message])    
@else
@include('layout.partials.left-nav', ['message' => 1])    
@endif
                        ...
                        <div class="card-content">
                            <div class="card-body text-center">
                                <div class="card-header pt-0 pb-0">
                                    ...
                                    style="
                                    border-radius: 50%;
                                    background-image: url('https://images.pexels.com/photos/1806900/pexels-photo-1806900.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=150&w=150);'
                                    ...
                                    <h3 class="display-4 blue-grey lighten-2">We Are Sorry for inconvience</h3>
                                </div>
                                <div class="card-content">
                                    <h1>Your Account has not been verfied yet!</h1>
                                    <p>
                                        Kindly add your company information, after reviewing your company information 
                                        Your account will be activated and you can start your business with us.
                                    </p>
                                </div>
                            </div>
                        </div>
...
@include('layout.partials.formater')
...
<script src="https://media.twiliocdn.com/sdk/js/chat/v3.3/twilio-chat.min.js"></script>
<script src="{{ asset('vendor/theme-assets/js/scripts/customizer.min.js') }}" type="text/javascript"></script>
