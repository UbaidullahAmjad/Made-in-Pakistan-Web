...
<v-app>
  <v-layout row>
    ...
    <v-flex id="privateMessageBox" class="messages mb-5" xs9>
      <message-list :user="user" :all-messages="allMessages" :offer="offer"></message-list>
      <!-- <app-alert></app-alert> -->
...
friends() {
  ...
  created() {
    ...
    Echo.private("privatechat." + this.user.id)
      ...
      .listen("OfferMadeEvent", (e) => {
        // this.message.push(e.offer);
        var x = confirm('Are you sure to confirm this order');
        console.log(x);
        if(x){
          axios.post('/tabs', {
          id: this.user.id,
